...
public class SecurityCofiguration extends WebSecurityConfigurerAdapter implements WebMvcConfigurer {
    ...
    public void addInterceptors(InterceptorRegistry registry) {
        ...
        .excludePathPatterns("/**/downloadCustomerKycLimitReport/**")
        .excludePathPatterns("/**/carddownloadList/**")
        .excludePathPatterns("/**/downloadCustomer/**")
        .excludePathPatterns("/**/downloadCustomerSumBalance/**")
        .excludePathPatterns("/**/downloadTransaction/**")
        .excludePathPatterns("/**/downloadCustomerBalance/**");
    }
}
